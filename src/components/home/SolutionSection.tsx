...
const items = [
  {
    ...
    desc: 'Qualquer pessoa escaneia o QR Code e vê o histórico completo do atleta em 0,3 segundos.',
  },
  {
    num: '02',
    icon: Lock,
    title: 'Imutável por criptografia',
    desc: 'Hash SHA-256 único por graduação. Ninguém pode alterar — nem a academia, nem nós.',
  },
  {
    num: '03',
    icon: Award,
    title: 'Passaporte vitalício',
    desc: 'O atleta leva o link para sempre. Troca de academia, fecha a escola — o passaporte permanece.',
  },
];

  ...
  return (
    <footer
      style={{
        ...
        padding: '48px var(--section-px-sm) 32px',
      }}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-wrap" style={{ gap: 48 }}>
          <div className="flex flex-col">
            <span style={{ fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 500, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', marginBottom: 16 }}>
              Produto
            </span>

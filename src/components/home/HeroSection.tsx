    ...
    >
      ...
      >
        <div
          style={{
            ...
            width: 280,
            height: 400,
            background: 'rgba(19,76,115,0.07)',
        ...
        <div
          style={{
            ...
            width: 220,
            height: 320,
            background: 'rgba(19,76,115,0.05)',
            borderRadius: 'var(--radius-md)',
        ...
        <div
          style={{
            ...
            width: 160,
            height: 280,
            background: 'rgba(19,76,115,0.04)',
            borderRadius: 'var(--radius-md)',
            transform: 'rotate(8deg) translateX(170px) translateY(120px)',
          }}
        />
      </div>
      ...
      >
        ...
        >
          ...
          do seu atleta,
          <br />
          <span style={{ color: 'var(--color-accent)' }}>imutável.</span>
        </h1>
        ...
        >
          Qualquer pessoa verifica a faixa do seu aluno em segundos
          — escaneando um QR Code. Para sempre. Sem falsificação possível.
        </p>

        {/* CTAs */}
        <div
          className="animate-fadeup delay-400 flex flex-wrap items-center"
        ...
        {/* Social proof stats */}
        <div
          className="animate-fadeup delay-500 flex flex-wrap items-center"
          style={{ gap: 48, marginTop: 64 }}
        >
          {stats.map((stat, i) => (
      ...
      {/* Mobile: reduce geometric opacity via CSS */}
      <style>{`

    ...
    <section style={{ background: 'var(--color-bg-dark)' }}>
      <div className="fp-container" style={{ padding: 'var(--section-py) 0' }}>
        <div className="section-inner">
          <h2 style={{ fontFamily: 'var(--font-sans)', fontWeight: 500, fontSize: 'clamp(40px, 5.5vw, 68px)', letterSpacing: '-0.03em', lineHeight: 1.06, color: '#FFFFFF', maxWidth: 600 }}>
            Sua academia merece isso.
          </h2>
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: 17, fontWeight: 400, color: 'rgba(255,255,255,0.55)', lineHeight: 1.65, maxWidth: 460, marginTop: 24 }}>
